...
class pes_network(object):
    ...
    def NAAL_command  (self, command=board_command.INIT, reserved=None):
        ...
        NA_status = self.NAAL_status()
        print("NAAL status : " + NA_status)
    ...
    def NAAL_step(self,data, error =False):
        ...
        maxdata = self.current_error[2:]# [0] = command, [1] = dt
...
if __name__ =="__main__":
   ...
   #     plt.show()
    ...
    test.NAAL_command(board_command.PAUSE)
