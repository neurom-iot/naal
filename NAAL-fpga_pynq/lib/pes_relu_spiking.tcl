...
if { $run_remote_bd_flow == 1 } {
  set str_bd_folder /home/fpgabuild/git/nengo-pynq-hw/source/vivado
...
# Hierarchical cell: pynq_pes
proc create_hier_cell_pynq_pes { parentCell nameHier } {

  variable script_folder

  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_msg_id "BD_TCL-102" "ERROR" create_hier_cell_pynq_pes() - Empty argument(s)!"}
     return
  }
  ...
  # Create instance: IN_dma, and set properties
  set IN_dma [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_dma:7.1 IN_dma ]
...
CONFIG.c_sg_length_width {13} \
  ...
  # Create instance: relu_pes, and set properties
  set relu_pes [ create_bd_cell -type ip -vlnv xilinx.com:hls:pynq_pes:1.0 relu_pes ]

  # Create instance: relu_pes_axi_periph, and set properties
  set relu_pes_axi_periph [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_interconnect:2.1 relu_pes_axi_periph ]
  set_property -dict [ list \
CONFIG.NUM_MI {1} \
 ] $relu_pes_axi_periph
  ...
  connect_bd_intf_net -intf_net IN_dma_M_AXIS_MM2S [get_bd_intf_pins IN_dma/M_AXIS_MM2S] [get_bd_intf_pins relu_pes/IN_ERR]
  connect_bd_intf_net -intf_net IN_dma_M_AXI_MM2S [get_bd_intf_pins M_AXI_MM2S] [get_bd_intf_pins IN_dma/M_AXI_MM2S]
  connect_bd_intf_net -intf_net OUT_dma_M_AXI_S2MM [get_bd_intf_pins M_AXI_S2MM] [get_bd_intf_pins OUT_dma/M_AXI_S2MM]
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M00_AXI [get_bd_intf_pins s_axi_ctrl] [get_bd_intf_pins relu_pes/s_axi_ctrl]
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M01_AXI [get_bd_intf_pins S_AXI_LITE1] [get_bd_intf_pins IN_dma/S_AXI_LITE]
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M02_AXI [get_bd_intf_pins S_AXI_LITE] [get_bd_intf_pins OUT_dma/S_AXI_LITE]
  connect_bd_intf_net -intf_net relu_pes_OUT_r [get_bd_intf_pins OUT_dma/S_AXIS_S2MM] [get_bd_intf_pins relu_pes/OUT_r]
  connect_bd_intf_net -intf_net relu_pes_axi_periph_M00_AXI [get_bd_intf_pins relu_pes_axi_periph/M00_AXI] [get_bd_intf_pins zynq_AXI_DNA_0/S00_AXI]
  connect_bd_intf_net -intf_net relu_pes_m_axi_DNA_in [get_bd_intf_pins relu_pes/m_axi_DNA_in] [get_bd_intf_pins relu_pes_axi_periph/S00_AXI]

  # Create port connections
  connect_bd_net -net ARESETN_1 [get_bd_pins ARESETN] [get_bd_pins relu_pes_axi_periph/ARESETN]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins m_axi_mm2s_aclk] [get_bd_pins IN_dma/m_axi_mm2s_aclk] [get_bd_pins IN_dma/s_axi_lite_aclk] [get_bd_pins OUT_dma/m_axi_s2mm_aclk] [get_bd_pins OUT_dma/s_axi_lite_aclk] [get_bd_pins relu_pes/ap_clk] [get_bd_pins relu_pes_axi_periph/ACLK] [get_bd_pins relu_pes_axi_periph/M00_ACLK] [get_bd_pins relu_pes_axi_periph/S00_ACLK] [get_bd_pins zynq_AXI_DNA_0/s00_axi_aclk]
  connect_bd_net -net rst_processing_system7_0_50M_peripheral_aresetn [get_bd_pins ap_rst_n] [get_bd_pins IN_dma/axi_resetn] [get_bd_pins OUT_dma/axi_resetn] [get_bd_pins relu_pes/ap_rst_n] [get_bd_pins relu_pes_axi_periph/M00_ARESETN] [get_bd_pins relu_pes_axi_periph/S00_ARESETN] [get_bd_pins zynq_AXI_DNA_0/s00_axi_aresetn]
...
CONFIG.NUM_MI {3} \
  ...
  # Create instance: pynq_pes
  create_hier_cell_pynq_pes [current_bd_instance .] pynq_pes

  # Create instance: rst_processing_system7_0_50M, and set properties
  set rst_processing_system7_0_50M [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 rst_processing_system7_0_50M ]

  # Create interface connections
  connect_bd_intf_net -intf_net IN_dma_M_AXI_MM2S [get_bd_intf_pins axi_mem_intercon/S00_AXI] [get_bd_intf_pins pynq_pes/M_AXI_MM2S]
  connect_bd_intf_net -intf_net OUT_dma_M_AXI_S2MM [get_bd_intf_pins axi_mem_intercon_1/S00_AXI] [get_bd_intf_pins pynq_pes/M_AXI_S2MM]
  ...
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M00_AXI [get_bd_intf_pins processing_system7_0_axi_periph/M00_AXI] [get_bd_intf_pins pynq_pes/s_axi_ctrl]
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M01_AXI [get_bd_intf_pins processing_system7_0_axi_periph/M01_AXI] [get_bd_intf_pins pynq_pes/S_AXI_LITE1]
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M02_AXI [get_bd_intf_pins processing_system7_0_axi_periph/M02_AXI] [get_bd_intf_pins pynq_pes/S_AXI_LITE]

  # Create port connections
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_mem_intercon/ACLK] [get_bd_pins axi_mem_intercon/M00_ACLK] [get_bd_pins axi_mem_intercon/S00_ACLK] [get_bd_pins axi_mem_intercon_1/ACLK] [get_bd_pins axi_mem_intercon_1/M00_ACLK] [get_bd_pins axi_mem_intercon_1/S00_ACLK] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP1_ACLK] [get_bd_pins processing_system7_0_axi_periph/ACLK] [get_bd_pins processing_system7_0_axi_periph/M00_ACLK] [get_bd_pins processing_system7_0_axi_periph/M01_ACLK] [get_bd_pins processing_system7_0_axi_periph/M02_ACLK] [get_bd_pins processing_system7_0_axi_periph/S00_ACLK] [get_bd_pins pynq_pes/m_axi_mm2s_aclk] [get_bd_pins rst_processing_system7_0_50M/slowest_sync_clk]
  ...
  connect_bd_net -net rst_processing_system7_0_50M_interconnect_aresetn [get_bd_pins axi_mem_intercon/ARESETN] [get_bd_pins axi_mem_intercon_1/ARESETN] [get_bd_pins processing_system7_0_axi_periph/ARESETN] [get_bd_pins pynq_pes/ARESETN] [get_bd_pins rst_processing_system7_0_50M/interconnect_aresetn]
  connect_bd_net -net rst_processing_system7_0_50M_peripheral_aresetn [get_bd_pins axi_mem_intercon/M00_ARESETN] [get_bd_pins axi_mem_intercon/S00_ARESETN] [get_bd_pins axi_mem_intercon_1/M00_ARESETN] [get_bd_pins axi_mem_intercon_1/S00_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M00_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M01_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M02_ARESETN] [get_bd_pins processing_system7_0_axi_periph/S00_ARESETN] [get_bd_pins pynq_pes/ap_rst_n] [get_bd_pins rst_processing_system7_0_50M/peripheral_aresetn]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x40400000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs pynq_pes/IN_dma/S_AXI_LITE/Reg] SEG_IN_dma_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x40410000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs pynq_pes/OUT_dma/S_AXI_LITE/Reg] SEG_OUT_dma_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs pynq_pes/relu_pes/s_axi_ctrl/Reg] SEG_relu_pes_Reg
  create_bd_addr_seg -range 0x20000000 -offset 0x00000000 [get_bd_addr_spaces pynq_pes/IN_dma/Data_MM2S] [get_bd_addr_segs processing_system7_0/S_AXI_HP0/HP0_DDR_LOWOCM] SEG_processing_system7_0_HP0_DDR_LOWOCM
  create_bd_addr_seg -range 0x20000000 -offset 0x00000000 [get_bd_addr_spaces pynq_pes/OUT_dma/Data_S2MM] [get_bd_addr_segs processing_system7_0/S_AXI_HP1/HP1_DDR_LOWOCM] SEG_processing_system7_0_HP1_DDR_LOWOCM
  create_bd_addr_seg -range 0x00010000 -offset 0x44A00000 [get_bd_addr_spaces pynq_pes/relu_pes/Data_m_axi_DNA_in] [get_bd_addr_segs pynq_pes/zynq_AXI_DNA_0/S00_AXI/S00_AXI_reg] SEG_zynq_AXI_DNA_0_S00_AXI_reg
